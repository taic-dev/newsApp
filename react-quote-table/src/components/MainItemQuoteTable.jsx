...
const MainItemQuoteTable = ({ changeTableCell, addTableRow, deleteTableRow, totalPrice, allTableRow }) => {
  return (
                ...
                {allTableRow.map((value,key)=>{
                    return(
                        <TableRow key={value.id} id={value.id}>
                            ...
                            <TableCell><DoNotDisturbOnIcon onClick={deleteTableRow}></DoNotDisturbOnIcon></TableCell>
                        </TableRow>
                    )
                })}
            </TableBody>
